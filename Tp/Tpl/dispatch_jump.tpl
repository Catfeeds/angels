...
.system-message{ padding:10% 5% 10% 5%;margin:5% 5% 0 10px; background-color:#FFFFFF; border:solid 1px #e5e5e5;box-sizing: border-box; text-align:center; min-height:100px}
...
.system-message .success,.system-message .error{ line-height: 2em; font-size: 1em; text-align:center}
