...
class StorageController extends CommController {
   ...
   //  		$brcodeObj =substr($brcodeObj, 3); 
		...
		if (!is_not_null($json))
		 ...
		 $json["proattrcolor"]!=''?$proattrcolor = $json["proattrcolor"]:$proattrcolor =0;
		 $json["proattrsize"]!=''?$proattrsize = $json["proattrsize"]:$proattrsize =0;
		 $json["proattrcheckid"]!=''?$proattrcheckid = $json["proattrcheckid"]:$proattrcheckid =0;
