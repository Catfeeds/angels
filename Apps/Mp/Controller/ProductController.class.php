    ...
    public function edit(){
        ...
        if(is_not_null($data['pro_pic']) && file_exists($imgpath.$data['pro_pic'])){
          ...
          if(is_not_null($data['pro_pic2']) && file_exists($imgpath.$data['pro_pic2'])){
            $arr=getimagesize($imgpath.$data['pro_pic2']);
            if(false!=$arr){
                $w=$arr[0];
                $h=$arr[1];
                if($h>60){
                ...
                $data['pro_pic2_str']='<img src="'.__ROOT__.'/Public/uploads/product/'.$data['pro_pic2'].'" width="'.$ww.'"  height="'.$hh.'"  border="0" style="vertical-align:middle" >';
            }
            else{
                $data['pro_pic2_str']='';
            }
