...
<header class="ui-header ui-header-positive ui-border-b">
	<i class="ui-icon-return" data-href="<?php echo U('./Angels/Dealer/invite');?>" ></i><h1>分享给朋友</h1>
</header>
<section class="ui-container" >
<div class="ui-whitespace" style="margin:5px 0 5px 0; text-align:center;" >
<div style="text-align:center; padding-top:10px"><?php echo ($dlt_name); ?> 邀请链接</div>
</div>
...
<div id="shareit" style="display:none">
  <img src="/Public/angels/static/fenxiang.png"  style="width: 242px; height: 180px;float: right;clear: both;">
</div>
