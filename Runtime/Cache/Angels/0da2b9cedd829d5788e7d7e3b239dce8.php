...
<header class="ui-header ui-header-positive ui-border-b ">
	<i class="ui-icon-return " data-href="<?php echo U('./Angels/Dealer/index');?>" ></i><h1 >代理申请</h1>
</header>
<section class="ui-container" >
<div class="ui-whitespace" style="margin:10px 0 10px 0" >
    <p>上级代理：<?php echo ($dlbelong_name); ?> </p>
</div>
<div class="ui-whitespace" style="margin:10px 0 10px 0" >
    <p>推荐人：<?php echo ($dlreferee["dl_name"]); ?> <?php if($dlreferee["dl_weixin"] != '' ): ?>(<?php echo ($dlreferee["dl_weixin"]); ?>)<?php endif; ?></p>
</div>
<div class="ui-form ui-border-t">
<form action="<?php echo U('./Angels/Dealer/apply');?>" action="" enctype="multipart/form-data" method="post" id="fmmm" name="fmmm" >
...
<div class="ui-form-item ui-border-b">
	<label>代理级别<?php echo (count($dltypelist)); ?></label>
	<div class="ui-select">
		<select name="dltype"  id="dltype"  >
		    <?php if(!empty($dltinfo["dlt_id"])): ?><option  value="<?php echo ($dltinfo["dlt_id"]); ?>" ><?php echo ($dltinfo["dlt_name"]); ?></option><?php endif; ?>
		</select>
	</div>
</div>
<div class="ui-form-item ui-border-b">
...
<div class="ui-tips ui-tips-warn" style="padding:0; font-size:14px" >
    <i></i><span id="timingtxt" >链接有效倒计时：</span><span id="timing"><?php echo ($timing); ?></span>
</div>
</section>
<script>
(function (){
