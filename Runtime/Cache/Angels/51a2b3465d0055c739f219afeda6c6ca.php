...
<header class="ui-header ui-header-positive ui-border-b">
	<i class="ui-icon-return" data-href="<?php echo U('./Angels/Dealer/shipsearch');?>" ></i><h1>查询结果</h1>
</header>
...
<ul class="ui-list ui-list-text  ui-border-tb">
    <li class="ui-border-t">
        <h4 class="ui-nowrap">条码：<?php echo ($shipinfo["code"]); ?></h4>
    </li>
	<li class="ui-border-t">
	 ...
	 <li class="ui-border-t">
        <h4 class="ui-nowrap">数量：<?php echo ($shipinfo["qty"]); ?></h4>
    </li>
	 <li class="ui-border-t">
