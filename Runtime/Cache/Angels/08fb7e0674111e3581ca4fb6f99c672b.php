...
<header class="ui-header ui-header-positive ui-border-b">
	<i class="ui-icon-return" data-href="<?php echo U('./Angels/Dealer/updatedltypeindex');?>"  ></i><h1>下级申请调级</h1>
</header>
...
<?php if(is_array($applydltypelist)): foreach($applydltypelist as $key=>$item): ?><li class="ui-border-t" >
        <div class="ui-list-info"   data-href="<?php echo U('./Angels/Dealer/updatedltypedetail2?apply_id='.$item['apply_id'].'');?>" >
