...
<header class="ui-header ui-header-positive ui-border-b">
	<i class="ui-icon-return" data-href="<?php echo U('./Angels/Dealer/referee');?>"  ></i><h1>我推荐的代理</h1>
</header>
...
<?php if(is_array($dllist)): foreach($dllist as $key=>$item): ?><li class="ui-border-t"  >
        <div class="ui-list-info">
            <h4 class="ui-nowrap"><?php echo ($item["dl_name"]); ?> <?php if($item["dl_number"] != '' ): ?>(<?php echo ($item["dl_number"]); ?>)<?php endif; echo ($item["dlstt_name"]); ?> <?php if($item["dl_status_str"] != '' ): echo ($item["dl_status_str"]); endif; ?></h4>
			<p class="ui-nowrap">微信号：<?php echo ($item["dl_weixin"]); ?>　　手机号：<?php echo ($item["dl_tel"]); ?></p>
			<p class="ui-nowrap">当前上家：<?php echo ($item["dl_belong_str"]); ?></p>
        </div>
