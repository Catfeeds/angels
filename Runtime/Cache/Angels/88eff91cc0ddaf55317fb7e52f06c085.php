...
<header class="ui-header ui-header-positive ui-border-b">
	<i class="ui-icon-return" data-href="<?php echo U('./Angels/Dealer/index');?>" ></i><h1>我推荐的代理</h1>
</header>
<section class="ui-container" >

<ul class="ui-list ui-list-text ui-list-link ui-border-tb">
<?php if(is_array($dltypelist)): foreach($dltypelist as $key2=>$item2): if($item2["dlt_level"] > 1 ): ?><li class="ui-border-t" data-href="<?php echo U('./Angels/Dealer/refereelist?dltid='.$item2['dlt_id'].'');?>" >
