...
<img src="/Public/uploads/product/<?php echo ($item["oddt_propic"]); ?>" style="vertical-align:middle; width:50%" /><?php endif; ?>
  ...
  <tr>
    ...
    <td class="txtright txtbold"  >&nbsp;合计：<?php if($ordersinfo["od_blid"] > 0): ?>(余额支付)<?php endif; ?></td>
    <td>&nbsp;<?php echo ($ordersinfo["odbl_total"]); ?> 元</td>
  </tr>
  <tr>
    <td class="txtright txtbold"   >&nbsp;支付凭证：</td>
    <td>&nbsp;<?php echo ($ordersinfo["odbl_paypic_str"]); ?></td>
...
<input type="hidden" name="odbl_id" id="odbl_id" value="<?php echo ($ordersinfo["odbl_id"]); ?>" />
