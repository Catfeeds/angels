		...
		shipin : '插入视频外链'
			...
			KindEditor.ready(function(K) {
				editor = K.create('#econtent', {
					...
					filterMode : true,
					fileManagerJson : '/Public/kedt4110/php/mobi_file_manager_json.php?sid=<?php echo ($sid); ?>&uid=<?php echo ($uid); ?>',
...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Jfmobi/product');?>">产品展示</A>　&gt;　<A href="#"><?php echo ($atitle); ?></A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Jfmobi/proedit_save');?>"   method="post" name="fmmm"  enctype="multipart/form-data" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <?php if(($qypurview["70008"]) == "70008"): ?><tr>     
			   ...
			   <tr>     
                  <td height="40"  class="txtright" > 产品价格：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="25"  name="pro_price" class="input" value="<?php if(($proinfo["pro_price"] != '') AND ($proinfo["pro_price"] != '0') ): echo (number_format($proinfo["pro_price"],2,'.','')); endif; ?>" ></td>
			  </tr>
			  
			   <tr>     
                  <td height="40"  class="txtright" >产品图片：</td>
				  <td  class="txtleft" >
				  <?php if(($proinfo["pro_pic_str"]) != ""): ?><a href="/Public/uploads/mobi/<?php echo ($proinfo["pro_pic"]); ?>" target="_blank" ><?php echo ($proinfo["pro_pic_str"]); ?></a><?php endif; ?> <input name="pic_file" type="file" /> (建议图片大小:600X600) <input type="hidden"  value="<?php echo ($proinfo["pro_pic"]); ?>" name="old_pro_pic" />
				  </td>
			  </tr>
			   
			   <tr>     
                  <td height="40"  class="txtright" > 购买链接/更详细链接：</td>
				  <td  class="txtleft" ><input type="text" size="106" maxlength="500"  name="pro_link" class="input" value="<?php echo ($proinfo["pro_link"]); ?>" > </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >产品描述：</td>
				  <td  class="txtleft" ><textarea name="econtent" id="econtent" style="width:640px;height:500px;"><?php echo (htmlspecialchars($proinfo["pro_desc"])); ?></textarea><br /><br /></td>
			  </tr>
