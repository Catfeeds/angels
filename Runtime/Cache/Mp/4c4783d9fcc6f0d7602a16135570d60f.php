...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">产品展示</A></div>
<div class="nav_r"><?php if(($qypurview["70008"]) == "70008"): ?><a href="<?php echo U('Mp/Jfmobi/protypelist');?>">产品分类</a><?php endif; ?>　<?php if(($qypurview["20002"]) == "20002"): ?><a href="<?php echo U('Mp/Jfmobi/proadd');?>">添加产品</a><?php endif; ?></div>
</div>
<div class="height10"></div>
<div>
<form action="<?php echo U('Mp/Jfmobi/product');?>"   method="post" name="fmmm"  >
<?php if(($qypurview["70008"]) == "70008"): ?><select name="pro_typeid"   class="select"  onChange="document.location.href ='<?php echo U('Mp/Jfmobi/product');?>?pro_typeid='+this.value;" >
				  ...
				  </select>　<?php endif; ?><input    type="text" size="20" maxlength="25"  name="keyword"  class="input"  value="<?php echo ($keyword); ?>"   >   <input type="submit" name="Submit" value="搜 索"  ></form></div>
<div class="height10"></div>
<div class="content">
...
<th  width="15%" ><span>产品编号</span></th>
<th  width="15%" ><span>产品类别</span></th>
...
<td class="data"><span><?php echo ($item["pro_pic_str"]); ?></span></td>
...
<td class="data"><span><a href="<?php echo U('Mp/Jfmobi/proactive?pro_id='.$item['pro_id'].'&pro_active='.$item['pro_active'].'');?>" ><img src="/Public/mp/static/<?php echo ($item['pro_active'] == 0?'no':'yes'); ?>.gif" /></a></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Jfmobi/proedit?pro_id='.$item['pro_id'].'');?>">修改</a> <a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Jfmobi/prodelete?pro_id='.$item['pro_id'].'');?>';" >删除</a></span></td>
